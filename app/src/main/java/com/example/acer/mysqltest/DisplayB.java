 ...
 */
public class DisplayB extends Activity
{
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                File pdfFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "merged_document.pdf");
                ...
                try {
                    if (pdfFile.exists()) {
                        ...
                        Toast.makeText(DisplayB.this, "File NotFound", Toast.LENGTH_SHORT).show();
                    }
                }
                catch (ActivityNotFoundException e) {
                    Toast.makeText(DisplayB.this,
