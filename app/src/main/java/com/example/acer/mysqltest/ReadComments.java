...
public class ReadComments extends ListActivity implements Serializable
{
   ...
   // private static final String READ_COMMENTS_URL = "http://192.168.1.7:80/webservice/comments.php?Mobile=" + myMob;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        READ_COMMENTS_URL = "http://192.168.1.100:80/webservice/comments.php?Mobile=" + myMob1;
        /*if(myMob1.equals("NA")){
    ...
    {
        Intent lineIntent = new Intent(ReadComments.this ,PieC.class);
