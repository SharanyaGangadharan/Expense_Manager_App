...
public class ReadComments3 extends ListActivity implements Serializable
{
   ...
   // private static final String READ_COMMENTS_URL = "http://192.168.1.7:80/webservice/comments.php?Mobile=" + myMob;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        READ_COMMENTS_URL = "http://192.168.1.100:80/webservice/comments3.php?Mobile=" + myMob1;
        /*if(myMob1.equals("NA")){
    ...
    {
        Intent lineIntent = new Intent(ReadComments3.this ,PieC.class);
    ...
    private void updateList() {
        ...
        ListAdapter adapter = new SimpleAdapter(this, mCommentList,
                R.layout.single_post, new String[] { TAG_PNAME,
    ...
    public class LoadComments extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ReadComments3.this);
